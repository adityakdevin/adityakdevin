...
export const metadata: Metadata = {
  title: { absolute: "AI Integration Audit - one week, fixed price, build-ready spec" },
  description:
...
const WEEK = [
  { step: "Day 1", h: "Access and context", body: "Read-only access to the codebase, plus one call with whoever knows the workflow best." },
  { step: "Days 2-3", h: "The read", body: "Architecture, data model, where the work actually happens, and where a model could sit without a rewrite." },
  { step: "Day 4", h: "Costing", body: "Volume, token estimates, provider pricing, and the latency budget for anything a user waits on." },
  { step: "Day 5", h: "The spec", body: "Written up and walked through on a call. You keep the document either way." },
];
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-16">
      ...
      <p className="mono mb-3 text-sm" style={{ color: "var(--muted)" }}>
        <span style={{ color: "var(--accent)" }}>$</span> cat services/ai-integration-audit.md
      </p>
      <h1 className="mono h2-rule text-4xl font-semibold leading-tight">
        AI Integration Audit: one week, fixed price
      </h1>
      <p className="mt-4 text-lg" style={{ color: "var(--muted)" }}>
        Most AI projects fail before a line of code, by picking the wrong thing to build. This is
        the week that stops that happening - and the cheapest possible way to find out I am the
        wrong person to hire.
      </p>
      ...
      <section className="mt-12">
        ...
        <p className="mt-6">
          ...
          write that document than take the project.
        </p>
        <p className="mt-3">
          For scale: most integrations that do go ahead land in the $2,000-$8,000 range. The audit
          is quoted separately on the call, fixed before it starts.
        </p>
      </section>
      ...
      >
        <h2 className="mono text-xl font-semibold">
          <span style={{ color: "var(--accent)" }}>Start here:</span> a 30-minute call
        </h2>
        <p className="mt-2">
          Describe the workflow that hurts. I tell you whether the audit is worth your money before
          you spend any of it.
        </p>
