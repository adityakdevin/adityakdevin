...
The demo works. The launch works. Six weeks later the model is quietly getting 15% of answers subtly wrong — not wrong enough for anyone to complain loudly, just wrong enough to erode trust one interaction at a time. Nobody notices, because everyone's watching uptime, not outputs.
