...
Our bot streams beautifully, but it still only knows what's in its system prompt. Next up: **[RAG in Laravel - embeddings and pgvector](/blog/rag-in-laravel-embeddings-and-pgvector-for-a-knowledge-base-bot)**, where we give it your actual documentation to answer from.
